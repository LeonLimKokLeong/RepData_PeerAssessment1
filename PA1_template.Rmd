...
hist(steps_by_day$steps, col = "blue", breaks=seq(0,22000,by=2000), xlab = "Total Steps per Day", main = "Total number of steps taken each day")
...
plot(steps_by_interval$interval, steps_by_interval$steps, type="l", main = "Average number of steps take across a day", xlab="Interval", ylab = "Steps")
...
for ( interval in steps_by_interval$interval)
{
        ...
        new_data[ new_data$interval == interval & is.na(new_data$steps) ,"steps" ] = round(steps_by_interval[ steps_by_interval$interval == interval ,"steps" ], 0)
}
...
hist(new_steps_by_day$steps, col = "blue", breaks=seq(0,22000,by=2000), xlab = "Total Steps per Day", main = "Total number of steps taken with missing values filled")
...
library(lattice)
xyplot(steps~interval|days,data=days_steps_by_interval, type=c("l","g"), layout=c(1,2), xlab = "Interval", ylab = "Steps", scales=list(x=list(at=seq(0,2359,100),rot=90 ), y=list(at=seq(0,max(days_steps_by_interval["steps"]),40) ) ) )
